...
public:
    ...
    NCReportPrinterOutput( NCReportPrinter::PrinterMode quality, int dpi=-1, QObject* parent=0 );
    NCReportPrinterOutput( const QPrinterInfo & printerInfo, NCReportPrinter::PrinterMode quality, int dpi=-1, QObject* parent=0 );
    ...
    virtual void adjustEndlessHeight( double heightMM );

protected:
    virtual QPrinter* createPrinter( NCReportPrinter::PrinterMode quality = NCReportPrinter::HighResolution, int dpi=-1 );
    virtual QPrinter* createPrinter(const QPrinterInfo & printerInfo, NCReportPrinter::PrinterMode quality = NCReportPrinter::HighResolution, int dpi=-1 );
    /*!
