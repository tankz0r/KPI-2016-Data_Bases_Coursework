...
{
public:
    NCReportSectionDirector( NCReportDirector *director, NCReportSection *section, NCReportGroup* group );
...
private:
    NCReportDirector *m_rd;
    NCReportSection *m_section;
    NCReportGroup *m_group;
    qreal m_totalZonesHeightMM;	// height of all zones
    ZoneMode m_zoneMode;
    bool m_pageBreakStop;

    QMap<int,NCReportZone> m_zones;
    QSet<NCReportItem*> m_hiddenItems;
