...
public:
    ...
    NCReportDataSource *dataSourceRef( const QString& id );
    ...
    void addGraphicsView( const QString id, QGraphicsView* view );
    QGraphicsView* graphicsView( const QString id );
    //const QHash<QString,QGraphicsView*>& graphicsViews() const;

#ifndef NCREPORT_NO_ITEM_VIEW
    void addItemView(const QString &id, QAbstractItemView *itemView );
    const QHash<QString,QAbstractItemView*>& itemViews();
#endif
    ...
    static QString zintInstallPath();

    void setDeleteDataSources(bool value);
    bool isDeleteDataSources() const;
...
private:
...
#ifndef NCREPORT_NO_ITEM_VIEW
    QHash<QString,QAbstractItemView*> m_itemViews;
#endif
    ...
    QHash<QString,QGraphicsView*> m_graphicsViews;
