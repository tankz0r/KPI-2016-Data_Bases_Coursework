...
class NCREPORTSHARED_EXPORT NCReportCrossTabIndex
{
public:
...
class NCREPORTSHARED_EXPORT NCReportCrossTabItem : public NCReportItem
{
public:
    ...
    void paint(NCReportOutput* output, const QPointF& );
...
private:
    ...
    bool paintCell( NCReportOutput* o, const NCReportCrossTabItemCell::CellType, const QVariant& value, QRectF& cellRect, const QRectF& itemRect, const NCReportCrossTabIndex& index);
