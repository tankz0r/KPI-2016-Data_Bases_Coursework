...
public:
    ...
    virtual QString primaryKeyValue() const;
    ...
    bool isUseApiOnly(void) const;
    void setUseApiOnly(bool value);

    bool    hasDataSourceTreeFieldItemResourceTypeSet() const;
    int     getDataSourceTreeFieldItemResourceType() const;
    bool    hasDataSourceTreeFieldItemTypeIdSet() const;
    int     getDataSourceTreeFieldItemTypeId() const;
...
protected:
    ...
    void setDataSourceTreeFieldItemResourceType(int dataSourceTreeFieldItemResourceType);
    void setDataSourceTreeFieldItemTypeId(int dataSourceTreeFieldItemTypeId);
...
private:
    ...
    bool    m_dataSourceTreeFieldItemResourceTypePreset;
    int     m_dataSourceTreeFieldItemResourceType;
    bool    m_dataSourceTreeFieldItemTypeIdPreset;
    int     m_dataSourceTreeFieldItemTypeId;
};
