...
class NCREPORTSHARED_EXPORT NCReportOutput : public QObject
{
    Q_OBJECT
public:
    enum OutputType { Preview=0, QtPreview, Printer, Pdf, PostScript, Svg, Image, Text, Xml, Html, Odf, ExcelHtml, ExcelXml, PlainText, Null, Custom, PdfWriter };
    ...
    void setPageFrom(int from);
    void setPageTo(int to);
