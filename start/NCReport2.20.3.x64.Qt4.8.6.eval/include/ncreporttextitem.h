 ...
 */
class NCREPORTSHARED_EXPORT NCReportTextItem : public NCReportItem
{
public:
...
protected:
    ...
    virtual void adjustFontF2( NCReportOutput* output =0 );
    virtual void adjustFontF3(NCReportOutput* output =0 );
