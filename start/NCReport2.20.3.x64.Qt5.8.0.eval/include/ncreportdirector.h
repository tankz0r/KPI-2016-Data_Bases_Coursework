...
public:
    ...
    bool reportProcess();
    bool reportSubProcess(bool doPageBegin, bool doPageEnd);
    int pageNum() const;
    ...
    NCReportSection* currentSection();
    ...
    void translatePaintPosX( qreal byMM );
    ...
    qreal spaceToBottomMM(qreal fromPosition = -1) const;
    qreal bottomYPosMM() const;
    ...
    void resetImagesAll();
    void resetImages( NCReportSection *section );

    void updateVariables();
    void updateDynamicItems();
    void updateSectionDynamicItems( NCReportSection *item );
    void updateCurrentDetailItems();
...
public:
     ...
     * This is neccessary for protection where to avoid lonely headers.
     */
    struct SectionInfo {
        /*!
         * \brief number
        ...
        /*!
         * \brief groupLevel
         * Stores the current group nested if there are existed groups.
         * This is needed for table of contents.
         */
        int groupLevel;
        ...
        /*!
         * \brief globalPageNumber
         * Stores the current global page number. Global page numbers are used when a batch mode is applied.
         * This is needed for table of contents.
         */
        ...
        /*!
         * \brief description
         * The section descriptor value is saved here.
         * This is needed for table of contents.
         */
        QString description;
        ...
        /*!
         * \brief reportNumber
         * The number of report. Makes sence in batch mode.
         */
        int reportNumber;
    ...
    int& sectionCounter();
    bool writeTableOfContents() const;
    void setPageIsClean( bool value );
...
private:
    ...
    int m_currentRow;
    NCReportSection* m_currentSection;
...
private:
    ...
    bool renderSection(NCReportSection* section, NCReportGroup *group = NULL);
    ...
    */
    ...
    bool normalReportProcess(bool doPageBegin, bool doPageEnd);
    bool labelProcess();
    ...
    void documentReportProcess_Items(NCReportSection* detail, QTextStream& inputHtml,
                                      ...
                                      QTextDocument* document, NCReportDataSource* dataSource );
