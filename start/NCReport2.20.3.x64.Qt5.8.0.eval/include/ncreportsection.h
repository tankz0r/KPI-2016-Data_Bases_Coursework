...
*/
class NCREPORTSHARED_EXPORT NCReportSection : public QGraphicsScene
{
    Q_OBJECT
public:
    ...
    virtual void addItemForEditor(NCReportItem* item, bool genZValue);

    virtual void addItemForEngine( NCReportItem* item);
    ...
    /*!
     * \brief descriptor
     * \return the descriptor expression
     * Data expression for table of contents generator.
     */
    inline QString descriptor() const { return m_descriptor; }
    void setDescriptor( const QString& descriptor ) { m_descriptor = descriptor; }
