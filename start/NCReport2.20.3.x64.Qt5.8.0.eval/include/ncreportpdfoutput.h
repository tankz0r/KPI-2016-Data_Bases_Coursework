...
class NCREPORTSHARED_EXPORT NCReportPdfOutput : public NCReportPrinterOutput
{
	Q_OBJECT
public:
    NCReportPdfOutput( NCReportPrinter::PrinterMode quality = NCReportPrinter::HighResolution, int dpi=-1, NCReportPrinter::OutputFormat outputFormat = NCReportPrinter::PdfFormat, QObject* parent=0);
...
private:
    NCReportPrinter::OutputFormat m_outputFormat;
