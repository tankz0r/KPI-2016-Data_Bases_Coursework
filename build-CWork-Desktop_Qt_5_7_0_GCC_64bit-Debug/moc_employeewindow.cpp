...
#include "../CWork/employeewindow.h"
...
QT_MOC_LITERAL(1, 15, 15), // "refreshPosition"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 6), // "accept"
QT_MOC_LITERAL(4, 39, 7), // "showAdd"
QT_MOC_LITERAL(5, 47, 11), // "showRefresh"
QT_MOC_LITERAL(6, 59, 11), // "refreshEmpl"
QT_MOC_LITERAL(7, 71, 10) // "chooseEmpl"

    },
    "EmployeeWindow\0refreshPosition\0\0accept\0"
    "showAdd\0showRefresh\0refreshEmpl\0"
    "chooseEmpl"
};
...
void EmployeeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->refreshPosition();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->accept(); break;
        case 2: { int _r = _t->showAdd();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 3: { int _r = _t->showRefresh();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 4: { int _r = _t->refreshEmpl();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 5: { int _r = _t->chooseEmpl((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
